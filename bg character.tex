...
We consider the $\beta\gamma$ theory on $\CC^d$ with values in a complex vector space $V$. 
We have already seen that when the complex dimension is $d = 2$, this theory is the holomorphic twist of the $\cN = 1$ chiral multiplet with on $\RR^4$. 
...
\begin{lem} The symmetry by $U(d) \times U(1)_f$ on the classical $\beta\gamma$ system with values in the complex vector space $V$ extends to a symmetry of the factorization algebra of quantum observables $\Obs^q$.
\end{lem}
\begin{proof}
...
Since the character is conjugation invariant, it is completely determined by its value on the subgroup $T^d \times U(1)_f \subset U(d) \times U(1)_f$. 
...
We have seen in Proposition \brian{ref} that when $d = 2$, the free $\beta\gamma$ system is equal to the holomorphic twist of the free $\cN=1$ chiral multiplet in four dimensions. 
