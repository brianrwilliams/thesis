...
\een
Here, $\d$ denotes the extension of the differential on $\fg$ to the symmetric algebra by the Leibniz rule, and $\d_{CE}$ \brian{finish}.
There is a similar

\begin{dfn}
Suppose $\sG$ is a factorization Lie algebra.
Let $\UU (\sG)$ be the composition
\end{dfn}
...
\ben
{\rm LocalLie}_X \to {\rm Fact}^{\rm Lie}_X \to {\rm Fact}_X
\een
If $\sL$ is a local Lie algebra we let $\UU(\sL)$ be the image under this composition, and refer to it as the {\em factorization enveloping algebra} of $\sL$. 
