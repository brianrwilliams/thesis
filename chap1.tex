...
We want to consider deformations that are invariant for the action by the total {\em super} Lie algebra $\CC^{2d|d} = \CC^{2d} \oplus \CC^d[1]$.
We denote by $(\Def_{\sE_V})^{\CC^{2d|d}}$ the space of such deformations.
