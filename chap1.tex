...
A {\em free holomorphic theory} on a complex manifold $X$ is the data $(V, Q^{hol}, (-,-)_V)$ as in (1), (2), (3) above such that $Q^{hol}$ is a square zero elliptic differential operator that is skew self-adjoint for the pairing $(-,-)_V$.
...
\begin{dfn}
An interacting holomorphic theory on a complex manifold $X$ is the data of a free holomorphic theory $(V, Q^{hol}, (-,-)_V)$ plus a functional
\ben
I^{hol} \in \olochol(V)'
\een
of cohomological degree zero \brian{check this} such that $Q^{hol} I^{hol} + \{I^{hol}, I^{hol}\}^{hol} = 0$.
\end{dfn} 
...
\brian{classical equivariant theory}

\subsection{Quantum equivariance}

Recall that in the BV formalism, as developed in \cite{CosRenormalization,CG}, 
