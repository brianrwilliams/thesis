...
\ben
(\varphi_1,\ldots, \varphi_k) \mapsto \int D_1(\alpha_1 \tensor \varphi_1)\cdots D_k(\alpha_k \tensor \varphi_k)
\een
...
The following is a useful table to show how we are producing a BV theory from a holomorphic theory.
...
In \cite{johanson}, or for a more mathematical treatment see \cite{CostelloYangian}, it is shown that this theory is a twist of $N=1$ supersymmetric Yang-Mills on $\RR^4$.
\end{eg}
...
For a full definition of this see Definition ?? in \ref{CG}. 
...
This is done in detail in Section \ref{} of \cite{CG}, and we refer the reader there for more details. 
