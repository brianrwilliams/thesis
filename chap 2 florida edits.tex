...
\een
The extended family $\{I^{\rm W} + \hbar \Tilde{J}\}$ determines a  family $\{I_{X,\alpha}[L]\}$ where, for each $L$,
\ben
I_{X,\alpha}[ = \Tilde{\rm char}_{X, \alpha} \left(I^{\rm W} + \hbar \Tilde{J}\right) . 
\een
...
The final part of the main theorem, Theorem \ref{thm: holsig}, is identifying the moduli of quantizations.
